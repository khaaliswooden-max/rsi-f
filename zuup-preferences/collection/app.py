...
# Add parent directory to path for imports (zuup-preferences); repo root for shared llm_client
import sys
_here = Path(__file__).resolve()
sys.path.insert(0, str(_here.parent.parent))
sys.path.insert(0, str(_here.parent.parent.parent))

from llm_client import generate_response_pair, get_placeholder_responses
...
# ============================================================================
# RESPONSE GENERATION (shared LLM client when use_llm=True; placeholders otherwise)
# ============================================================================
...
def generate_responses(
    ...
    """Generate two responses for comparison. If use_llm=True, use real LLM (default); else placeholders."""
    if use_llm:
        return generate_response_pair(prompt, domain_id=domain_id)
    return get_placeholder_responses(prompt, domain_id=domain_id)
