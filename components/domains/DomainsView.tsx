...
import { ChevronRight, Search, Target, Layers } from "lucide-react";
import clsx from "clsx";
import { DOMAINS, DIMENSION_LABELS } from "@/src/utils/api";
              ...
              >
                ...
                {isOpen && detail && (
                  <div className="border-t border-bp-border px-4 py-4 space-y-4">
                    {/* Description */}
                    <p className="text-sm text-bp-text-secondary leading-relaxed">{detail.description}</p>
                    ...
                    <div className="rounded bg-bp-dark3 border border-bp-border px-3 py-2.5">
                      ...
                      <p className="text-xs text-bp-text-secondary leading-relaxed">{detail.sample_task}</p>
                    </div>
                  </div>
                )}
              </div>
